    ...
    <div className={clsx("md:flex md:flex-row md:justify-between", "2xl:mx-24")}>
      <nav className={clsx("mb-4", "md:mb-0")} aria-label="Footer Navigation">
        <ul className={clsx("mb-0")}>
          <li className={clsx("mb-0 -ml-3 pt-4 pb-4", "md:pt-0 md:pb-0 md:inline-block md:mr-16")}>
            <Link href="/imprint">
              <a
                className={clsx(
          ...
          <li className={clsx("mb-0 -ml-3 pt-4 pb-4 inline-block", "md:ml-0 md:pt-0 md:pb-0 md:mr-16")}>
