...
const Save: React.FunctionComponent<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={clsx("w-6 h-6", className)} aria-hidden="true" focusable="false" {...props}>
