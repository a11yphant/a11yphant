...
const Sidebar: React.FunctionComponent<SidebarProps> = ({ classes, challengeName, instructions }) => {
  return (
    <aside className={`${classes} flex flex-col border-2 rounded-lg border-primary relative box-border overflow-hidden w-1/5`}>
      <div className="flex flex-col w-80 h-full absolute">
        <h2>{challengeName}</h2>
        <h3 className={`flex items-center justify-center h-16`}>Instructions</h3>
